...
class AnalysisServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AnalyzeImage = channel.unary_unary(
                '/analysis.AnalysisService/AnalyzeImage',
                request_serializer=analysis__pb2.AnalyzeImageRequest.SerializeToString,
                response_deserializer=analysis__pb2.AnalyzeImageResponse.FromString,
                _registered_method=True)
...
def add_AnalysisServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AnalyzeImage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=analysis__pb2.AnalyzeImageRequest.FromString,
                    response_serializer=analysis__pb2.AnalyzeImageResponse.SerializeToString,
            ),
    }
...
class AnalysisService(object):
    ...
    def AnalyzeImage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/analysis.AnalysisService/AnalyzeImage',
            analysis__pb2.AnalyzeImageRequest.SerializeToString,
            analysis__pb2.AnalyzeImageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
